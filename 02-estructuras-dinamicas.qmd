...
CircularLinkedList <- R6::R6Class(
  ...
  public = list(
    ...
    append = function(valor) {
      ...
      if (is.null(self$head)) {
        ...
        while (
          ...
          current$next_node$value != self$head$value
        ) {
    ...
    delete = function(valor) {
      ...
      # Un solo nodo
      if (
        !is.null(self$head$next_node) &&
        self$head$next_node$value == self$head$value &&
      ...
      if (current$value == self$head$value) {
        ...
        while (
          ...
          temp_tail$next_node$value != self$head$value
        ) {
